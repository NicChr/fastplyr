...
### Details on optimised functions

fastplyr categorises all expressions into one of 3 categories

1. Standard expressions
2. Group-unaware expressions
3. Group-aware optimiseable expressions

The first category are normal expressions and are just expressions which don't
belong to the other 2 categories. These get evaluated normally.
...
### Optimising group-unaware functions

Common base R functions can be thought of as group-unaware in the sense that
