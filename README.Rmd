...
|                | slow for many       | methods                    |
|                | groups              |                            |
+----------------+---------------------+----------------------------+
| Duplicate rows | No dedicated        | Dedicated function         |
|                | function for this,  | `f_duplicates` can do this |
...
|                | types of joins,     | joins of the form `x == y` |
|                | e.g. rolling and    |                            |
|                | equality joins.     |                            |
+----------------+---------------------+----------------------------+
...
|                | sub-setted          | `grouped_df` with a row ID |
|                | implictly using     | col. Implicit `[[`         |
