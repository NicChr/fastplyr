...
test_that("C/C++ call functions", {
  ...
  q1 <- quote(1 + 2)
  q2 <- quote(base::`+`(1, 2))
  q3 <- quote(base::`+`(1 + (3 - base::`/`(5, 10))))

  expect_true(is_group_unaware_call(q1, env))
  expect_true(is_group_unaware_call(q2, env))
  expect_true(is_group_unaware_call(q3, env))
  ...
  expect_false(is_group_unaware_call(q1, env))
  expect_true(is_group_unaware_call(q2, env))
  expect_false(is_group_unaware_call(q3, env))
