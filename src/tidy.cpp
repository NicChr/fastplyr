...
// Extract useful group metadata in one pass, including:
// - group IDs
// - Group starts (first value of group rows list)
// - Group sizes (length of group row elements)
// - TRUE/FALSE to indicate whether group IDs are sorted
// - Sorted group start locations
// - Max group size
